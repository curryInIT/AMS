...
<div class="content">
    <div id="yourposition" >
        <p class="text-info" style="font-size:16px; font-family:宋体">你现在的位置：身份证办理 > 身份证挂失</p>
    </div>
    <%
            ...
            <center>
                <div style="width:400px;">
                    <form>
                        ...
                        <br>
                        <button type="button" class="btn btn-lg btn-info" onclick="javascript:window.location.href='/idCard_abolish'">挂失</button>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--中间结束-->
<script>
    var info="${requestScope.abolishInfo}";
    if(info!=""){
        alert(info);
    }
</script>
