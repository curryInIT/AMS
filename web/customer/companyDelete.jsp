...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/customer/css/companyDelete.css" />
...
<div class="content">
    <div id="yourposition" >
        <p class="text-info" style="font-size:16px; font-family:宋体">你现在的位置：公司业务 > 公司注销</p>
    </div>
    <%
        ...
        <div id="left">
            <center>
                <div style="width:400px;">
                    <form>
                        <br><br><br>
                        <input  name="companyName" class="form-control" value="公司名称：<%=company.getCompanyName()%>" readonly="readonly">
                        <br>
                        <input  name="applyCustomer" class="form-control"  value="法人姓名：<%=company.getApplyCustomer()%>" readonly="readonly" >
                        <br>
                        <input  name="customerIdNumber" class="form-control"  value="法人身份证号：<%=company.getCustomerIdNumber()%>" readonly="readonly">
                        <br>
                        <input  name="customerPhone" class="form-control" value="电话号码：<%=company.getCustomerPhone()%>" readonly="readonly">
                        <br>
                        <input  name="customerEmail" class="form-control"  value="电子邮箱：<%=company.getCustomerEmail()%>" readonly="readonly">
                        <br>
                        <input  name="customerAddress" class="form-control"  value="法人家庭住址：<%=company.getCustomerAddress()%>" readonly="readonly">
                        <br>
                        <input  name="companyAddress" class="form-control"  value="公司地址：<%=company.getCompanyAddress()%>" readonly="readonly">
                        <br>
                        <input  name="managerArea" class="form-control"  value="经营范围：<%=company.getManagerArea()%>" readonly="readonly">
                        <br>
                        <input  name="managerProducts" class="form-control" value="经营产品：<%=company.getManagerProducts()%>" readonly="readonly">
                        <br>
                        <textarea  name="companyDescribe" class="form-control" readonly="readonly">公司描述：<%=company.getCompanyDescribe()%></textarea>
                        <br>
                        <input  name="registerMoney" class="form-control" value="注册资金：<%=company.getRegisterMoney()%>" readonly="readonly" >
                        <br>
                        <button type="button" class="btn btn-lg btn-info" onclick="javascript:window.location.href='/company_delete'">注销</button>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <button type="button" class="btn btn-lg btn-info" onclick="JavaScript:window.location.href='${pageContext.request.contextPath}/customer/index.jsp'">取消</button>
                    </form>
                </div>
            </center>
        </div>
...
<!--中间结束-->
<script>
    var info="${requestScope.deleteInfo}";
    if(info!=""){
        alert(info);
    }
</script>
