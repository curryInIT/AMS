...
<div class="content">
    ...
    <%
        Vehicle vehicle = (Vehicle)request.getAttribute("vehicleDetail");
        if(vehicle!=null){
    %>
    <div id="main">
        <div id="left">
            <center>
                <div style="width:400px;">
                    <form>
                        <br><br><br>
                        <input  name="customerName" class="form-control" value="姓名：<%=vehicle.getCustomerName()%>" readonly="readonly" >
                        <br>
                        <input  name="idCard" class="form-control" value="驾驶证号：<%=vehicle.getIdCard()%>" readonly="readonly">
                        <br>
                        <input  name="phone" class="form-control" value="电话号码：<%=vehicle.getPhone()%>" readonly="readonly">
                        <br>
                        <input  name="email" class="form-control" value="电子邮箱：<%=vehicle.getEmail()%>" readonly="readonly">
                        <br>
